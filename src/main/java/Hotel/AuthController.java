	...
	public String saveBooking(
	    ...
	    try {
	        ...
	        if(promoCode != null && !promoCode.trim().isEmpty()){
	            ...
	            else if(codeInput.equals("WELCOME15")) promoPercent = 15;
	            else if(codeInput.equals("LUXE20")) promoPercent = 20;
	            else if(codeInput.equals("VIP25")) promoPercent = 25;
	            else if(codeInput.equals("GOLD30")) promoPercent = 30;
	            else if(codeInput.equals("FAMILY40")) promoPercent = 40;
	            else if(codeInput.equals("MEGA50")) promoPercent = 50;
	            else if(codeInput.equals("NEWGUEST90")) promoPercent = 90;
	            else if(codeInput.equals("LUXE55")) promoPercent = 55;
	            else if(codeInput.equals("ROYAL60")) promoPercent = 60;
	            else if(codeInput.equals("PARADISE65")) promoPercent = 65;
	            else if(codeInput.equals("ELITE70")) promoPercent = 70;
	            else if(codeInput.equals("DIAMOND75")) promoPercent = 75;
	            else if(codeInput.equals("SUNSET80")) promoPercent = 80;
	            else if(codeInput.equals("GOLD85")) promoPercent = 85;
	            else if(codeInput.equals("PLATINUM90")) promoPercent = 90;
	            else if(codeInput.equals("PRESTIGE95")) promoPercent = 95;
	            else if(codeInput.equals("SOLEIL100")) promoPercent = 100;
	            else {
